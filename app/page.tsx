    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 dark:from-slate-900 dark:to-slate-800">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="flex flex-col items-center justify-center text-center">
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
            Smart Parking <span className="text-blue-600 dark:text-blue-400">Made Simple</span>
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-muted-foreground">
            Find, book, and navigate to available parking slots in real time. The smartest way to park your vehicle.
          </p>
        ...
        <div className="mt-24 grid gap-8 md:grid-cols-3">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Discover available parking spots near you in real-time</CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <CardFooter>
              <p className="text-sm text-muted-foreground">
                Our interactive map shows you all available parking spots with real-time status updates.
              </p>
            </CardFooter>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Reserve your spot with just a few taps</CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <CardFooter>
              <p className="text-sm text-muted-foreground">
                Book parking spots in advance or on-the-go with our seamless booking system.
              </p>
            </CardFooter>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>For parking lot owners and managers</CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <CardFooter>
              <p className="text-sm text-muted-foreground">
                Optimize your parking lot operations with our management tools and analytics.
              </p>
            </CardFooter>
          </Card>
        </div>
      ...
      <footer className="container mx-auto mt-24 border-t px-4 py-6">
        <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <p className="text-sm text-muted-foreground">© 2024 Park'n'Pal. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
